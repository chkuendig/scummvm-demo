...
if wheremouse2="data" bitmaptoscreentrans text1,60,24,0; varset flag5,1
if wheremouse2="openseq" bitmaptoscreentrans text3,264,152,0; varset flag1,1
if wheremouse2="tech" bitmaptoscreentrans text2,480,28,0; varset flag3,1 
if wheremouse2="asoft" bitmaptoscreentrans text4,248,272,0; varset flag2,1
...
if flag5=1 if wheremouse2<>"data" bitmaptoscreen mask5,64,24; varset flag5,0
if flag1=1 if wheremouse2<>"openseq" bitmaptoscreen mask1,264,152;varset flag1,0
if flag3=1 if wheremouse2<>"tech" bitmaptoscreen mask3,480,28; varset flag3,0
if flag2=1 if wheremouse2<>"asoft" bitmaptoscreen mask2,248,272; varset flag2,0
...
bitmaptoscreen mask5,60,24; varset flag5,0
bitmaptoscreen mask1,264,152;varset flag1,0
bitmaptoscreen mask3,480,28; varset flag3,0
bitmaptoscreen mask2,248,272; varset flag2,0
...
compute dayofyear, 268-dayofyear; compute year, 1997-year; compute hour, 9-hour; compute minute, 60-minute; compute second, 60-second
...
bitmapalloc pressspace,312,17
bitmapfromscreen pressspace,322,457
:mrloop
...
:waitforspace
bitmaptoscreen pressspace,322,457
systemtimer flash
...
screenfilledbox 322,457,312,17,0
systemtimer flash
compute flash, flash+500
:loopb
inputcharordelay click,0
...
bitmapalloc text1,136,44
bitmapalloc text2,96,36
bitmapalloc text3,96,20
bitmapalloc text4,144,20
bitmapalloc text5,68,13
bitmapalloc text6,84,10
bitmapfromscreen text1,60,24
bitmapfromscreen text2,480,28
bitmapfromscreen text3,264,152
bitmapfromscreen text4,248,272
...
return
:assignmasks
bitmapalloc mask5,136,44
bitmapalloc mask3,96,36
bitmapalloc mask1,96,20
bitmapalloc mask2,144,20
bitmapalloc mask4,68,13
bitmapalloc mask6,84,10
bitmapfromscreen mask5,60,24
bitmapfromscreen mask3,480,28
bitmapfromscreen mask1,264,152
bitmapfromscreen mask2,248,272
